...
export default function LoginPage() {
  ...
  return (
    <div
      className={`min-h-screen flex items-center justify-center px-4 transition-colors duration-200 ${mounted && dark ? 'bg-slate-900' : 'bg-gradient-to-br from-indigo-50 via-white to-slate-100'} relative`}
    >
